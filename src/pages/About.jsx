...
export default function About() {
  return (
    <div className="page-wrapper about-page">
      ...
      <section className="about-section container">
        <h2 className="section-title">Quem fez isso aqui</h2>
        <p className="section-subtitle">Três estudantes de Computação/Matemática Aplicada correndo atrás do prazo 🏃</p>
